                        ...
                        <section className='flex items-center justify-between w-full'>
                          ...
                          <div className='flex items-center gap-1'>
                            <button
                              ...
                              className='text-muted text-xs cursor-pointer hover:text-white transition-all duration-300 ease-in-out hover:scale-105 hover:bg-gray-700/50 px-2 py-1 rounded-md'
                            >
                              Resume
                            </button>
                          </div>
